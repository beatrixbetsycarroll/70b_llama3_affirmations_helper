sample_goals = [
    ...
    "To get an amazing new job that gives me financial abundance and levels me up in the world financially, and that also uses my Machine Learning skills as well as my talents for creative thinking, collaboration with a team, and ingenuity at problem solving when the pressure is on",
